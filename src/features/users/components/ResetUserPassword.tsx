...
import { useResetPassword } from '../domain/usecase.ts';
...
export default function ResetUserModal({ user, ref, usertype }: ResetUserModalProps) {
  const title = 'Reset Password for ';
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      toast(`Password reset link sent to ${user.email}`, { type: 'success' });
  ...
  return (
    ...
    >
      <>
        <h1>Are you sure you want to reset this {usertype} password?</h1>
